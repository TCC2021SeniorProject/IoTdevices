...
class RaspberryPi0:
    ...
    async def Turning5(self):
        await asyncio.sleep(0.01)
        if self.piNum == 0:
            out = piI.Shell('rotate 90', self.piNum) # variable?
        else:
            out = piI.Shell('rotate -90', self.piNum) # variable?
        print(out)
    ...
    async def Moving4(self):
        await asyncio.sleep(0.01)
        out = piI.Shell('move 1', self.piNum) # variable?
        print(out)
    ...
    async def Turning1(self):
        print('In Pi0 Turning1()')
        await asyncio.sleep(0.01)
        if self.piNum == 0:
            out = piI.Shell('rotate 180', self.piNum) # variable?
        else:
            out = piI.Shell('rotate -180', self.piNum) # variable?
        print(out)
        while 'rotated' not in out:
